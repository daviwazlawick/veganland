export default {
  ...
  profile_setup: {
    ...
    allergy_title: 'Ce que tu évites',
  ...
  home: {
    ...
    no_allergies: 'Rien de configuré',
    ...
    no_allergies_configured: 'Rien de configuré',
  ...
  result: {
    ...
    allergens_found: 'Trouvé dans ton profil',
    allergens_none: 'Rien de ton profil détecté',
