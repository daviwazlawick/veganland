export default {
  ...
  profile_setup: {
    ...
    allergy_title: 'What do you avoid?',
  ...
  home: {
    ...
    no_allergies: 'Nothing configured',
    ...
    no_allergies_configured: 'Nothing configured',
  ...
  result: {
    ...
    allergens_found: 'Found in your profile',
    allergens_none: 'Nothing from your profile detected',
