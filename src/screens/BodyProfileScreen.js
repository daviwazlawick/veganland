...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 10, padding: 12, fontSize: 16, color: Colors.navy || '#0B1E3F' },
  optionRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  optionBtn: { flex: 1, minWidth: 80, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 10, borderWidth: 1.5, borderColor: '#e2e8f0', alignItems: 'center' },
  optionSelected: { backgroundColor: Colors.navy || '#0B1E3F', borderColor: Colors.navy || '#0B1E3F' },
  ...
  listOptionSelectedText: { color: Colors.navy || '#0B1E3F', fontWeight: '700' },
  radio: { width: 18, height: 18, borderRadius: 9, borderWidth: 2, borderColor: '#cbd5e1' },
  radioSelected: { borderColor: Colors.navy || '#0B1E3F', backgroundColor: Colors.navy || '#0B1E3F' },
  saveBtn: { backgroundColor: Colors.navy || '#0B1E3F', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 4 },
