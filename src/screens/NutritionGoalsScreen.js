...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: '#EEF4FF', borderRadius: 20, paddingVertical: 8, paddingHorizontal: 16, alignSelf: 'flex-start' },
  badgeText: { fontSize: 12, fontWeight: '700', color: Colors.navy || '#0B1E3F' },
  ...
  fieldLabel: { flex: 1, fontSize: 14, fontWeight: '600', color: Colors.navy || '#0B1E3F' },
  fieldInput: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  input: { width: 80, borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 8, padding: 8, fontSize: 15, fontWeight: '700', textAlign: 'right', color: Colors.navy || '#0B1E3F' },
  unit: { fontSize: 12, color: '#94a3b8', width: 26 },
  note: { fontSize: 12, color: '#94a3b8', textAlign: 'center', lineHeight: 18 },
  saveBtn: { backgroundColor: Colors.navy || '#0B1E3F', padding: 16, borderRadius: 14, alignItems: 'center' },
  saveBtnText: { color: '#fff', fontSize: 16, fontWeight: '800' },
  resetBtn: { alignItems: 'center', paddingVertical: 10 },
  resetBtnText: { color: Colors.navy || '#0B1E3F', textDecorationLine: 'underline', fontSize: 13 },
});
